      ...
      <div className="grid overflow-hidden rounded-[36px] bg-white shadow-sm ring-1 ring-slate-100 lg:grid-cols-2">
        <div className="bg-gradient-to-br from-sky-500 via-violet-500 to-pink-500 p-8 text-white lg:p-10">
          ...
          <div className="mt-8 space-y-4">
            {['Lưu tiến độ tự động', 'Theo dõi nhiều bé trong một tài khoản', 'Nhận gợi ý bài học mỗi ngày'].map((item) => (
        ...
        <div className="p-8 lg:p-10">
          <div className="mx-auto max-w-md">
            <h2 className="text-2xl font-black tracking-tight text-slate-900">Chào mừng quay lại</h2>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-full bg-gradient-to-r from-sky-500 to-violet-500 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-sky-100 transition duration-300 hover:-translate-y-0.5 hover:from-sky-600 hover:to-violet-600 hover:shadow-xl hover:shadow-sky-200 disabled:opacity-60"
              >
