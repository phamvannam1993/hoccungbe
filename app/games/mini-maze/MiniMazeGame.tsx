...
type PlayQuestion = MazeQuestion;
...
export default function MiniMazeGame() {
  ...
  const tryMove = async (dRow: number, dCol: number) => {
    if (!currentQuestion || !playerPos || showResult) return;
              ...
              {mazeCategories.map((category) => (
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-7 text-slate-600">
                    {category.total} màn mê cung theo chủ đề này.
                  </p>
  ...
  if (finished) {
    ...
    return (
      <section className="mx-auto max-w-4xl px-3 py-4 sm:px-6 sm:py-8 lg:px-8 lg:py-12">
        <div className="rounded-[26px] bg-white p-4 shadow-sm ring-1 ring-slate-100 sm:rounded-[36px] sm:p-6 lg:p-8">
    ...
    <section className="mx-auto max-w-6xl px-3 py-4 sm:px-6 sm:py-8 lg:px-8 lg:py-12">
      <div className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr] lg:gap-8">
        <div className="rounded-[26px] bg-white p-4 shadow-sm ring-1 ring-slate-100 sm:rounded-[36px] sm:p-6 lg:p-8">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="rounded-full bg-violet-50 px-4 py-2 text-sm font-bold text-violet-700 ring-1 ring-violet-100">
                {mazeData[selectedCategory].label}
              </span>
              <span
          ...
          <p className="mt-4 max-w-3xl text-base leading-8 text-slate-600">
            Bé hãy dùng các nút điều hướng để đưa nhân vật tới đích.
          </p>
            ...
            <div className="rounded-[20px] bg-white p-3 shadow-inner sm:rounded-[24px] sm:p-5">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="rounded-2xl bg-emerald-100 px-3 py-2 text-sm font-bold text-emerald-700">
                  Màn {currentIndex + 1}/{questions.length}
                </div>
              </div>
          ...
          <div className="rounded-[30px] bg-white p-6 shadow-sm ring-1 ring-slate-100">
            ...
            <div className="mt-5 flex items-center gap-4 rounded-3xl bg-sky-50 p-5 ring-1 ring-sky-100">
              <div className="flex h-16 w-16 items-center justify-center rounded-[24px] bg-gradient-to-br from-yellow-300 via-pink-400 to-violet-500 text-3xl shadow-lg">
                {mazeData[selectedCategory].icon}
              </div>
              <div>
