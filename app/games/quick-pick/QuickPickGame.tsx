...
type PlayQuestion = QuickPickQuestion & {
  shuffledOptions: string[];
};

const LOCAL_STORAGE_KEY = 'hoc-cung-be-quick-pick-scores';
const SOUND_ENABLED_KEY = 'hoc-cung-be-quick-pick-effects-enabled';
const SPEECH_ENABLED_KEY = 'hoc-cung-be-quick-pick-speech-enabled';
...
function buildPlayQuestions(source: QuickPickQuestion[], count: number): PlayQuestion[] {
...
export default function QuickPickGame() {
  ...
  useEffect(() => {
    ...
    const categoryInfo = quickPickData[selectedCategory];
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">
                Nhìn nhanh và chọn đúng
              </h1>

              <p className="mt-4 max-w-3xl text-base leading-8 text-slate-600">
                Bé đọc yêu cầu ngắn rồi chọn đúng hình tương ứng. Mỗi lượt chơi sẽ tự
                trộn câu hỏi và vị trí đáp án để tăng khả năng quan sát và phản xạ.
              </p>
            </div>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_0.9fr]">
            <div className="rounded-[30px] bg-slate-50 p-6 ring-1 ring-slate-100">
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                {[
                  'Quan sát nhanh hơn',
                  'Nhận biết hình ảnh chính xác hơn',
                  'Tăng phản xạ khi chọn đáp án',
                  'Tập trung tốt hơn trong thời gian ngắn',
                ].map((item) => (
                  <div
                    key={item}
    ...
    <section className="mx-auto max-w-6xl px-6 py-8 lg:px-8 lg:py-12">
      <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
        <div className="rounded-[36px] bg-white p-6 shadow-sm ring-1 ring-slate-100 lg:p-8">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="rounded-full bg-violet-50 px-4 py-2 text-sm font-bold text-violet-700 ring-1 ring-violet-100">
                {quickPickData[selectedCategory].label}
              </span>
          ...
          <p className="mt-4 max-w-3xl text-base leading-8 text-slate-600">
            Bé đọc yêu cầu thật nhanh rồi chọn đúng hình tương ứng. Trò chơi giúp tăng
            phản xạ, khả năng nhận biết và tập trung trong thời gian ngắn.
          </p>
            ...
            <div className="rounded-[24px] bg-white p-5 shadow-inner">
              ...
              <div className="mt-6 rounded-3xl bg-sky-50 p-6 text-center ring-1 ring-sky-100">
                <p className="text-sm font-semibold text-slate-500">
                  Bé hãy nhìn nhanh và chọn đáp án đúng
                </p>
              ...
              {showResult && (
                ...
                >
                  {selected === currentQuestion.correct
                    ? 'Chính xác rồi. Bé chọn rất nhanh và đúng.'
          ...
          <div className="rounded-[30px] bg-white p-6 shadow-sm ring-1 ring-slate-100">
            ...
            <div className="mt-5 flex items-center gap-4 rounded-3xl bg-sky-50 p-5 ring-1 ring-sky-100">
              <div className="flex h-16 w-16 items-center justify-center rounded-[24px] bg-gradient-to-br from-yellow-300 via-pink-400 to-violet-500 text-3xl shadow-lg">
                {quickPickData[selectedCategory].icon}
              </div>
              <div>
