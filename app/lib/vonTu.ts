...
export const VON_TU_TOPICS: VonTuTopic[] = [
  {
    ...
    words: [
      ...
      { tu: 'bươm bướm', emoji: '🦋', nghia: 'con vật có đôi cánh sặc sỡ, bay từ hoa này sang hoa khác.', vd: 'Bươm bướm bay quanh vườn hoa.' },
  ...
  },
  {
    ...
    words: [
      ...
      { tu: 'bóng đèn', emoji: '💡', nghia: 'đồ dùng để thắp sáng trong nhà.', vd: 'Tối đến, em bật bóng đèn cho sáng phòng.' },
